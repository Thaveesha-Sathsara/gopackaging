  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-900 text-gray-50 hover:bg-blue-900 hover:text-gray-50 focus:bg-blue-900 focus:text-gray-50",
        day_today:
          "bg-blue-100 text-gray-900",
        day_outside:
          "day-outside text-gray-500 aria-selected:bg-blue-100/50 aria-selected:text-gray-500",
