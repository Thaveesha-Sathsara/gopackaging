...
const Payslip = forwardRef(({ data, dateRange }, ref) => {
  ...
  return (
    ...
    >
      {/* HEADER */}
      <div className="flex justify-between items-start border-b border-gray-400 pb-6 mb-6 mt-8">
      ...
      {/* EMPLOYEE DETAILS */}
      <div className="grid grid-cols-2 gap-y-1 mb-6 text-[14px]  border-b border-gray-400 pb-6 text-gray-600">
        <div className="flex">
...
//         Generated by LCS Enterprises - G.O Packaging Workforce Management System • {new Date().toLocaleString()}
//       </div>
//     </div>
//   );
// });
