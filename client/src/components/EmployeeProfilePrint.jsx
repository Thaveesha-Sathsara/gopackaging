...
const EmployeeProfilePrint = forwardRef(({ employee }, ref) => {
    ...
    >
            ...
            <div className="flex flex-col" style={{ minHeight: '280mm' }}>
                ...
                <div className="flex items-start justify-between mb-6 pb-6 mt-8 border-b border-gray-400">
                    <div>
                ...
                <div className="pt-24 border-t border-gray-400">
                    <div className="flex justify-between w-full px-8 mb-8">
                        {/* Employee Signature */}
                        <div className="text-center">
                            <div className="border-t border-gray-800 w-56 mx-auto mb-1"></div>
                            <p className="font-semibold text-sm mt-2">{employee.employeeName}</p>
                        ...
                        <div className="text-center">
                            <div className="border-t border-gray-800 w-56 mx-auto mb-1"></div>
                            <p className="font-semibold text-sm mt-2">HR/Authorized Signatory</p>
                            <p className="text-xs text-gray-600">LCS Enterprises</p>
                        </div>
                    </div>

                    {/* FOOTER */}
                    <div className="text-center text-xs text-gray-500 border-t border-gray-200 pt-2">
                        Generated by Workforce Management System • Confidential Document
                    </div>
                </div>
            </div>
        </div>
